...
class ProjectHelper:
    ...
    def open_project_page(self):
        self.wd.find_element_by_xpath('//a[@href="/mantisbt-1.2.20/manage_overview_page.php"]').click()
        self.wd.find_element_by_xpath('//a[@href="/mantisbt-1.2.20/manage_proj_page.php"]').click()

    def create_project(self, project):
        self.open_project_page()
        # Create New Project
        self.wd.find_element_by_xpath("//input[@value='Create New Project']").click()
        self.fill_project_form(project)
        # Add Project
        self.wd.find_element_by_xpath("//input[@value='Add Project']").click()
        self.open_project_page()
    ...
    def delete_project_by_name(self, name):
        ...
        self.wd.find_element_by_xpath("//input[@value='Delete Project']").click()
        self.wd.find_element_by_xpath("//input[@value='Delete Project']").click()
        self.open_project_page()
        self.project_cache = None
